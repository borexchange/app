...
const description = computed(() => {
  ...
  if (props.error?.statusCode === 405) {
    return 'You have been banned from accessing this page.'
  }
  ...
  if (props.error?.statusCode === 503) {
    return 'The site is currently under maintenance. Please try again later.'
  }
